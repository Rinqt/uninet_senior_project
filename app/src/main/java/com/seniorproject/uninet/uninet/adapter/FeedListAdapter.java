package com.seniorproject.uninet.uninet.adapter;
...
import com.seniorproject.uninet.uninet.AppVolleyController;
import com.seniorproject.uninet.uninet.FeedImageView;
import com.seniorproject.uninet.uninet.R;
import com.seniorproject.uninet.uninet.feed.data.FeedPost;

import java.util.List;

/*This adapter class takes care following things.
...
public class FeedListAdapter extends BaseAdapter {
    ...
    private List<FeedPost> feedItems;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.post_template, null);
